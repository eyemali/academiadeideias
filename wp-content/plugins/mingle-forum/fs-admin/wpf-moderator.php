	...
	<tr>
		...
		echo "<p class='wpf-alignright'><input type='checkbox'  id='mod_global' name='mod_global' onclick='invertAll(this, this.form, \"mod_forum_id\");' value='true' /> <strong>".__("Global moderator: (User can moderate all forums)", "mingleforum")."</strong></p>";
					...
					echo "</td></tr>
							<tr>
								<td colspan='2'>
								<span style='float:left'><input class='button' type='submit' name='add_mod_submit' value='".__("Add moderator", "mingleforum")."' /></span><span class='button' style='float:right'><a href='http://cartpauj.icomnow.com' target='_blank'>cartpauj.icomnow.com</a></span></td>
							</tr>
			</table>";
}
else
