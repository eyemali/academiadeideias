		...
		function about(){
			...
			echo " <div class='wrap'>
               ...
               <table class='widefat'> <thead>
				...
				<ul>
<li><h3>".__("Author: ", "mingleforum")."<a href='http://cartpauj.icomnow.com'>Cartpauj</a></h3></li>
<strong>".__("Plugin Page:", "mingleforum")."</strong> <a class='button' href='http://cartpauj.icomnow.com/projects/mingle-forum-plugin'>Mingle Forum</a><br /><br />
...
<strong>".__("Mingle Forum Skins:","mingleforum")."</strong>  <a class='button' href='http://cartpauj.icomnow.com/forum/?mingleforumaction=viewforum&f=5.0'>Get More Skins</a>
		...
		echo "/> ($defStr = ".__('Off', 'mingleforum').")</td>
			...
			echo "<tr class='alternate'>
			 ...
			 echo "<tr class='alternate'>
				<td valign='top'>".__("Closed Categories (Admin posting only):", "mingleforum")."<br/><small>".__("Comma separated list of Category ID's", "mingleforum")."</small></td><td><input type='text' name='forum_disabled_cats' value='".implode(",", $op['forum_disabled_cats'])."' /></td>
			</tr>";

			echo "<tr class='alternate'>
			<td colspan='2'>
			<span style='float:left'><input class='button' type='submit' name='mingleforum_option_save' value='". __("Save options", 'mingleforum')."'  /></span>
			<span class='button' style='float:right'><a href='http://cartpauj.icomnow.com' target='_blank'>cartpauj.icomnow.com</a></span>
		</tr>
		</table>
		</form>";
